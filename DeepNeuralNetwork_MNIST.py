...
"""
Created on Fri Jul  9 19:32:08 2021
...
logPath = "./tensorboard_logs/"

#   Adding summaries statistics for use in TensorBoard visualization.  
...
#Interactive session makes it the default sessions so we do not need to pass sess 
...
# Using RELU as our activation function.  These must be initialized to a small positive number 
...
# Convolution and Pooling - applying Convolutions, and then pooling to control overfitting
...
# Process the 32 features from Convolution layer 1, in 5 X 5 patch.  return 64 features weights and biases
    ...
    # Run convolution of the output of the 1st convolution layer.  Pool results 
